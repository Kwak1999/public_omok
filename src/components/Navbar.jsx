    ...
    return (
        <nav className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg dark:bg-neutral-800'>
            <div className='flex items-center justify-between w-full h-full px-10'>
                <div className='flex items-center'>
                    ...
                    <ul className='hidden md:flex'>
                        <li className='text-neutral-800 dark:text-gray-300'><Link to="home" smooth={true} duration={500}>Home</Link></li>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8 dark:bg-neutral-800'}>
                ...
                <li className='w-full border-b-2 border-zinc-300 text-gray-700 dark:text-gray-300'><Link onClick={() => setNav(false)} to="home" smooth={true} duration={500}>Home</Link></li>
